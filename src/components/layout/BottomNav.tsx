import { Home, Target, BookHeart, Users, Heart, User } from "lucide-react";
      ...
      <div className="mx-auto flex max-w-lg items-center justify-around px-2 py-2">
        {navItems.map((item) => (
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                "flex flex-col items-center gap-1 rounded-xl px-3 py-2 text-xs font-medium transition-all duration-300",
                isActive
